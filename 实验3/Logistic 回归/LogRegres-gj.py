...
def plotBestFit(weights):
	...
	ax.scatter(xcord1, ycord1, s = 20, c = 'red', marker = 's',alpha=.5)#绘制正样本，marker:指定散点图的形状，默认为圆形
...
def plotWeights(weights_array1,weights_array2):
	...
	plt.setp(axs0_title_text, size=20, weight='bold', color='black')       #weight='bold'加粗
